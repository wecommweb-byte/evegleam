...
export default function Header() {
  ...
  const headerClass = `fixed top-0 left-0 right-0 z-50 transition-all duration-400 ease-in-out bg-brand-pink bg-texture-1 backdrop-blur-md shadow-soft text-brand-dark`;
